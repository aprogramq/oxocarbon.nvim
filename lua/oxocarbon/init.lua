...
vim.api.nvim_set_hl(0, "FloatBorder", {fg = oxocarbon.base03, bg = oxocarbon.blend})
...
vim.api.nvim_set_hl(0, "TelescopeBorder", {fg = oxocarbon.base03, bg = oxocarbon.blend})
vim.api.nvim_set_hl(0, "TelescopePromptBorder", {fg = oxocarbon.base03, bg = oxocarbon.blend})
